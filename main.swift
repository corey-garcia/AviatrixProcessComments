...
func gauges(myPlane : Aviatrix) {
    ...
    //rest of these gauges below are changed in Iteration 2
    print("| Distance:  | \(myPlane.totalDistance) miles")
...
func fly(myPlane : Aviatrix) {
    ...
    for (index, city) in destinations.enumerated() {
        let distance = myPlane.distanceTo(from: myPlane.currentLocation, target: city)
...
var plane = Aviatrix(authorName: "Corey W. Garcia")
...
//added in Iteration 0
print("Thanks for flying with Corey W. Garcia airline!")
